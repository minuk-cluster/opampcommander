...
import dev.minuk.opampcommander.application.usecases.Capabilities
import dev.minuk.opampcommander.application.usecases.CustomMessage
...
object OpampMapper {
    ...
    fun Opamp.AgentToServer.toAgentExchangeRequest(): AgentExchangeRequest {
        ...
        val customCapabilities =
            if (hasCustomCapabilities()) {
                customCapabilities.toDomain()
            } else {
                null
            }
        val customMessage =
            if (hasCustomMessage()) {
                customMessage.toDomain()
            } else {
                null
            }
